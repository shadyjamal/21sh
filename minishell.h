...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/01/24 00:58:56 by cjamal            #+#    #+#             */
/*   Updated: 2020/01/24 21:27:17 by cjamal           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define EQUAL_TO(v, v1, v2, v3) ((v) == (v1) || (v) == (v2) || (v) == (v3))
...
void			ft_display_g_prompt(char *prt, int error);
...
char			***parsesep(char **cmd, int sep_count, char *sep, int *sizesep);
...
** Execution
*/
int				ft_exec_bin(char **cm, t_env_var *var, t_list *env, _Bool fork);
void			ft_execpipe(t_cmd_holder *hold, int pipecount,
													t_env_var *var, int *ret);
